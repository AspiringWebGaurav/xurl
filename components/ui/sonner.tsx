        ...
        <Sonner
            ...
            toastOptions={{
                classNames: {
                    ...
                    closeButton:
                        "!left-auto !right-0 !top-0 !translate-x-[35%] !-translate-y-[35%] !bg-background !border-border !text-foreground hover:!bg-muted shadow-md transition-all hover:scale-110 !opacity-100",
                },
            }}
            {...props}
        />
