            ...
            if (u) {
                ...
                snapshotUnsub = onSnapshot(doc(db, "users", u.uid), (docSnap) => {
                    if (docSnap.exists()) {
                        ...
                        const newDocSig = `${userData.plan}_${userData.activeLinks}_${JSON.stringify(userData.giftQuotas || [])}_${userData.planExpiry || ""}_${userData.apiEnabled}_${userData.cumulativeQuota}`;
