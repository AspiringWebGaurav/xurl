...
import { Home, BarChart2, Settings, Plus, Loader2 } from 'lucide-react';
        ...
        return (
            <div className="flex flex-col flex-1 w-full bg-background overflow-hidden">
                ...
                <MobileGuestLocked 
                    ...
                    message="Create an account to access your personal dashboard, track all your links, and see real-time performance."
                >
