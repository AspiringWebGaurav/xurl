...
const endpoints = [
    ...
    {
        method: "POST",
        path: "/api/custom-pricing-request",
        description: "Submit a custom enterprise pricing & volume proposal.",
        auth: "None",
        rateLimit: "5/15min (IP), 3/30min (Email)",
    },
    {
        method: "POST",
        path: "/api/user/data-deletion-request",
        description: "Request complete account data deletion under GDPR/CCPA.",
        auth: "Required",
        rateLimit: "1/hr",
    },
    {
        method: "GET",
        path: "/api/user/partial-offers",
        description: "Fetch personalized curated plans and upgrade deals.",
        auth: "Required",
        rateLimit: "—",
    },
    {
        ...
        description: "Fetch public system flags, pricing, and operational state.",
        auth: "None",
        rateLimit: "Edge 60s",
    },
    {
